...
echo "{$row['Name']}";
?>
<?php $sql="SELECT * FROM Faculty WHERE FID=(SELECT FID FROM Team WHERE TID={$row['TID']})";
$result=mysqli_query($con,$sql) or die("Bad Query: $sql");
$row=mysqli_fetch_assoc($result);
?>
<!-- Sidebar on click -->
...
<h2><?php $sql="SELECT * FROM Team WHERE TID={$row['TID']}";
$result=mysqli_query($con,$sql) or die("Bad Query: $sql");
$row=mysqli_fetch_assoc($result);
...
<div class="w3-row"><br>
<?php 
$sql="SELECT * FROM Team WHERE TID={$row['TID']}";
$result=mysqli_query($con,$sql) or die("Bad Query: $sql");
$row=mysqli_fetch_assoc($result);
